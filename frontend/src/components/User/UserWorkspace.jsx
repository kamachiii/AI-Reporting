...
function pesanDariHistory(m, idx, allMsgs = []) {
  ...
  try {
    ...
    if (parsed && (Array.isArray(parsed.rows) || parsed.source === 'clarification' || parsed.status === 'clarification_needed' || parsed.is_conversational_text || parsed.source === 'conversational')) {
      answer = parsed;
    }
  } catch {
